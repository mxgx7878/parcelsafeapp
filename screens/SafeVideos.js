...
export default function SafeVideos() {
  const navigation = useNavigation();
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
              <StatusBar barStyle="dark-content" backgroundColor="#FFFFFF"/>
            <SafeAreaView style={styles.container}>
                <TouchableOpacity style={styles.camBtn} onPress={()=> navigation.navigate('video-play')}>
                    <Text style={styles.camText}>Recording 123 - 5/5/2023 </Text>
